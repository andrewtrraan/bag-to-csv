...
real_table = arguments.table_name.replace('.bag','_json')
...
#the file location
file_location = cur_dir +'/output/' +f_name
...
str0 = cur_dir +'/output/' +arguments.table_name.replace('.bag','_db_str0.txt')
str1 = cur_dir +'/output/' +arguments.table_name.replace('.bag','_db_str1.txt')
